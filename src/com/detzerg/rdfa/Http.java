...
public class Http {
     ...
     * @throws IOException
     */
    public Http(String requestURL, String charset)
            throws IOException {
    ...
    public List<String> finish() throws IOException {
        ...
        if (status == HttpURLConnection.HTTP_OK) {
            ...
            ReadableByteChannel readableChannelForHttpResponseBody = Channels.newChannel(httpConn.getInputStream());
 
            // Create the file channel to save file
            FileOutputStream fosForDownloadedFile = new FileOutputStream("web.rdf");
